...
| `Features/CanonIntegrity/Rules/` | The nine production rules: three structural, three chronological, two relationship constraints, one world rule check. |
