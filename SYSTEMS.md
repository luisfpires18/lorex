...
| `src/lib/localDrafts.ts` | Recovery copies of unsaved writing in the browser's IndexedDB: keyed by account, universe, kind and id; one ordered queue per copy; every failure a rejected promise. Never sent anywhere. |
