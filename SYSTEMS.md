...
| `Features/FamilyTrees/FamilyTreeDerivation.cs` | Family positions derived from parent links by id alone - parents, grandparents, siblings, children, grandchildren - and the circles among them, found without recursion. |
