...
| `Features/Universes/UniverseEndpoints.cs` | Owner-scoped CRUD, search, paging, archive; a delete that releases the universe's ideas first, in one transaction. |
